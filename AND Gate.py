# -*- coding: utf-8 -*-
"""
Created on Wed Sep  7 15:27:56 2022
...
if __name__ == '__main__':
    print("\n\ncalculation for AND gate")
    X = np.array([[0, 0],[0, 1],[1, 0],[1, 1]])
    d = np.array([0, 0, 0, 1])
    perceptron = Perceptron(input_size=2, lr= 0.1, bias = 0)
    perceptron.fit(X, d)
    print("Optimize weights for AND gate", perceptron.W)